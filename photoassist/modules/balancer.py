...
class Balancer(BaseModule):
	"""Коррекция баланса/экспозиции по белому квадрату около метки ArUco.

	Использует среднее по выделенному белому региону для нормализации каналов.
	"""
	def __init__(
			self,
	...
	def _process(self, input_data: Dict) -> Dict:
		"""Ищет метку ArUco, берёт белый патч, нормализует каналы изображения."""
	...
	def _apply_transform(self, input_data: Dict) -> np.ndarray:
		"""Возвращает копию изображения после коррекции."""
...
def get_aruco_corners(
	...
	"""Находит углы маркера ArUco с заданным индексом. Возвращает ndarray Nx2 или None."""
